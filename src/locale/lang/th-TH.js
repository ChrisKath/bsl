...
const lang = {
  i: {
    ...
    form: {
      title: {
        auth: 'การยืนยันตัวตน',
        authInfo: 'ยินดีต้อนรับสู่ Brand Short Link - Project',
        resetPass: 'ลืมรหัสผ่าน',
        resetInfo: 'ยืนยันบัญชีของคุณ เพื่อตั้งรหัสผ่านใหม่'
      },
      note: {
        zero: 'ฟีเจอร์การตั้งรหัสผ่านใหม่ จะพร้อมใช้งานเร็วๆนี้...',
        ...
        three: 'ถ้าคุณไม่ได้บัญชี โปรดติดต่อผู้ดูแลระบบ หากคุณต้องการใช้งานระบบนี้'
      },
      display: 'ชื่อเล่น',
      email: 'ที่อยู่อีเมล',
      user: 'ชื่อผู้ใช้',
